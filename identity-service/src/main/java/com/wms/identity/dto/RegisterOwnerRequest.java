...
public record RegisterOwnerRequest(
    ...
    @NotBlank(message = "Tax ID is required")
        ...
        String taxId,
    @NotBlank(message = "Address is required") @Size(min = 5, max = 255) String address,
    @NotBlank(message = "City is required") @Size(min = 2, max = 100) String city,
    @NotBlank(message = "Country is required") @Size(min = 2, max = 100) String country) {}
