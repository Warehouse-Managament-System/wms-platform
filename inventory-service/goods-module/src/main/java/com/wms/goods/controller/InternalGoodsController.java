...
import com.wms.goods.dto.receipt.GoodsAvailableQtyResponse;
...
public class InternalGoodsController {
    ...
    public GoodsAvailableQtyResponse getAvailableQty(@PathVariable UUID id) {
        return service.getAvailableQty(id);
    }
}
